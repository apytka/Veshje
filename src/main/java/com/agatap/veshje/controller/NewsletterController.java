...
public class NewsletterController {
    ...
    @PostMapping
    public NewsletterDTO createNewsletterDTO(@RequestBody CreateUpdateNewsletterDTO createNewsletterDTO) throws NewsletterDataInvalidException, NewsletterAlreadyExistsException {
